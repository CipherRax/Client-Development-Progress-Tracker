...
export const Input = React.forwardRef<HTMLInputElement, React.InputHTMLAttributes<HTMLInputElement>>(
  ({ className, ...props }, ref) => (
    <input
      ref={ref}
      className={cn(
        'flex h-9 w-full rounded-md border border-line bg-transparent px-3 py-1 text-sm text-ink dark:text-white shadow-none transition-colors placeholder:text-ink/40 dark:placeholder:text-zinc-500 focus-visible:outline-none focus-visible:border-brand focus-visible:ring-1 focus-visible:ring-brand disabled:cursor-not-allowed disabled:opacity-50',
        className,
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <textarea
    ref={ref}
    className={cn(
      'flex min-h-[80px] w-full rounded-md border border-line bg-transparent px-3 py-2 text-sm text-ink dark:text-white shadow-none transition-colors placeholder:text-ink/40 dark:placeholder:text-zinc-500 focus-visible:outline-none focus-visible:border-brand focus-visible:ring-1 focus-visible:ring-brand disabled:cursor-not-allowed disabled:opacity-50',
      className,
    )}
    {...props}
  />
